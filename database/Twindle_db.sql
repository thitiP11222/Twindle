...
CREATE TABLE Product(
    ...
    sRentprice varchar(8), -- short term rent
    lRentprice varchar(8), -- long term rent
...
INSERT INTO Product (
  ...
  qualityStatus, image_url, user_id, category_name
)
VALUES
('เสื้อยืด Oversized', 'เสื้อยืดผ้าคอตตอนใส่สบาย เหมาะสำหรับทุกวัน', 'Uniqlo', 290.00, 70.00, 120.00, 'ใหม่', 'assets/imgs/product/pd1.jpg', 'U001', 'เสื้อผ้า'),
('เดรสสายเดี่ยวลายดอก', 'ชุดเดรสลายดอกน่ารัก ใส่เที่ยวทะเลหรือเดตได้', 'Polemo', 450.00, 150.00, 280.00, 'ดีมาก', 'assets/imgs/product/pd2.jpg', 'U002', 'แฟชั่น'),
('รองเท้าส้นสูง', 'รองเท้าส้นสูงสีดำ สำหรับใส่ออกงานหรือสัมภาษณ์', 'H&M', 390.00, 120.00, 180.00, 'ดีมาก', 'assets/imgs/product/pd3.jpg', 'U003', 'รองเท้า'),
('กระเป๋าสะพายข้าง', 'กระเป๋าสะพายหนังเทียม ช่องใส่ของเยอะ', 'Charles & Keith', 790.00, 180.00, 350.00, 'ใหม่มาก', 'assets/imgs/product/pd4.jpg', 'U004', 'กระเป๋า'),
('แว่นกันแดดแฟชั่น', 'แว่นกันแดดทรง Oversized สีดำ สไตล์เกาหลี', 'Gentle Monster', 1000.00, 200.00, 400.00, 'ใหม่', 'assets/imgs/product/pd5.jpg', 'U005', 'แอคเซสซอรี่'),
('กระโปรงพลีทสั้น', 'กระโปรงสั้นทรงเอพลีท ใส่แล้วดูน่ารัก สดใส', 'Zara', 850.00, 140.00, 270.00, 'ใหม่', 'assets/imgs/product/pd6.jpg', 'U001', 'เสื้อผ้า');
('แจ็คเก็ตยีนส์วินเทจ', 'แจ็คเก็ตยีนส์ทรงหลวม สไตล์ยุค 90s ใส่ได้ทั้งชายหญิง', 'Levi', 450.00, 150.00, 200.00, 'ดีมาก', 'assets/imgs/product/pd7.jpg', 'U002', 'เสื้อผ้า'),
('ชุดเซ็ตออกกำลังกาย', 'เซ็ตเสื้อกล้ามกับกางเกงเลกกิ้ง ยืดหยุ่นสูง ซึมซับเหงื่อดี', 'Nike', 500.00, 120.00, 200.00, 'ใหม่มาก', 'assets/imgs/product/pd8.jpg', 'U003', 'กีฬา'),
('หมวกบักเก็ตผ้าลินิน', 'หมวกบักเก็ตทรงสวย ระบายอากาศได้ดี ใส่กันแดด', 'MUJI', 290.00, NULL, NULL, 'ดีมาก', 'assets/imgs/product/pd9.jpg', 'U004', 'แอคเซสซอรี่');
...
VALUES
-- 📦 เสื้อ
('เสื้อยืด Oversized', 'เสื้อยืดผ้าคอตตอนใส่สบาย เหมาะสำหรับทุกวัน', 'Uniqlo', 350.00, 70.00, 120.00, 'ใหม่', 'assets/imgs/product/pd1.jpg', 'U001', 'เสื้อผ้า'),

-- 👗 เดรส
('เดรสสายเดี่ยวลายดอก', 'ชุดเดรสลายดอกน่ารัก ใส่เที่ยวทะเลหรือเดตได้', 'Polemo', 950.00, 150.00, 280.00, 'ดีมาก', 'assets/imgs/product/pd2.jpg', 'U002', 'แฟชั่น'),

-- 👠 รองเท้า
('รองเท้าส้นสูง', 'รองเท้าส้นสูงสีดำ สำหรับใส่ออกงานหรือสัมภาษณ์', 'H&M', 790.00, 120.00, 220.00, 'ดีมาก', 'assets/imgs/product/pd3.jpg', 'U003', 'รองเท้า'),

-- 👜 กระเป๋า
('กระเป๋าสะพายข้าง', 'กระเป๋าสะพายหนังเทียม ช่องใส่ของเยอะ', 'Charles & Keith', 1290.00, 180.00, 350.00, 'ใหม่มาก', 'assets/imgs/product/pd4.jpg', 'U004', 'กระเป๋า'),

-- 👓 แว่นกันแดด
('แว่นกันแดดแฟชั่น', 'แว่นกันแดดทรง Oversized สีดำ สไตล์เกาหลี', 'Gentle Monster', 1600.00, 200.00, 400.00, 'ใหม่', 'assets/imgs/product/pd5.jpg', 'U005', 'แอคเซสซอรี่'),
